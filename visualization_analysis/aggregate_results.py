...
def aggregate_results(input_dir: str, output_dir: str):
    ...
    results_by_dataset_task = {}  # dataset -> task_introduction -> list of folder results
...
def generate_summary_spreadsheet(dataset: str, task_intro: str, folder_data: List[Dict], output_path: Path):
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description='Aggregate incremental learning test results')
    parser.add_argument('--input-dir', required=True, help='Directory containing detailed CSV files')
    parser.add_argument('--output-dir', required=True, help='Directory to save summary spreadsheets')
